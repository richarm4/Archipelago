...
class NarutoWorld(World):
    ...
    web = web_world.NarutoWebWorld()

    # This is how we associate the options defined in our options.py with our world.
    options_dataclass = options.NarutoOptions
    options: options.NarutoOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    def create_item(self, name: str) -> items.NarutoItem:
